    ...
    <div className="inter flex h-screen">
      ...
      <div className="w-1/2 py-3 px-25 max-w-screen-lg mx-auto">
        <div className="text-[10px] flex justify-end">
          ...
          <Link to="/login">
            <span className="underline ml-2">Sign in &rarr;</span>
          </Link>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="cursor-pointer w-[300px] text-sm bg-black py-2 text-white rounded-sm"
          >
            Continue &gt;
          </button>
        </form>
        ...
        <button
          ...
          className="cursor-pointer flex w-[300px] text-sm py-2 px-2 rounded-2xl border border-gray-300"
        >
